...
export class CreateTenantComponent implements OnInit {
    ...
    constructor(private router: Router, private authService: AuthenticationService, private waAppService: WAAppService) {
    ...
    createTenant() {
      ...
      this.waAppService.AppSvcPost('createtenant', body).subscribe(result => {
        if (result === 'success'){
