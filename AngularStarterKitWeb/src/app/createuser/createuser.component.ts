...
import { WAAppService } from '../_services/waapp.service';
...
export class CreateUserComponent implements OnInit {
  ...
  constructor(private router: Router, private authService: AuthenticationService, private waAppService: WAAppService, private _ias: IzendaApiService) {
    ...
    createUser() {
      ...
      this.waAppService.AppSvcPost('createuser', data).subscribe(result => {
          if (result === 'success') {
